...
// Compatibility for minimal forks that only keep a subset of arches/types.
#ifndef LLM_ARCH_FALCON
#define LLM_ARCH_FALCON ((llm_arch)-1)
#endif

#ifndef LLM_ARCH_LLAMA
#define LLM_ARCH_LLAMA ((llm_arch)-1)
#endif

#ifndef LLM_TYPE_70B
#define LLM_TYPE_70B ((llm_type)-1)
#endif
...
static bool tensor_allows_quantization(const llama_model_quantize_params * params, llm_arch arch, const ggml_tensor * tensor) {
    ...
    quantize &= name != "pos_embd.weight";
    quantize &= name != "type_embd.weight";

@{
  Paths = @{
    ExecuTorchRepoRoot = "C:/Apps/Qwen3.cpp/upstream"
    ExecuTorchBuildDir = "build/executorch-win-vulkan-pybind-cp311"
    ExecuTorchInstallPrefix = "C:/Apps/Qwen3.cpp/upstream/build/executorch-win-vulkan-pybind-cp311/install"
    ExecuTorchRoot = "C:/Apps/Qwen3.cpp/upstream/third_party/executorch"
    RuntimeRoot = "runtime"
